...
const requiredSchemaSnippets = [
  ...
  /stream_id TEXT NOT NULL/i,
  /processed_height NUMERIC\(78,\s*0\)/i,
  /target_height NUMERIC\(78,\s*0\)/i,
  /CREATE SCHEMA IF NOT EXISTS squid_processor/i,
  /CREATE TABLE IF NOT EXISTS squid_processor\.status/i,
