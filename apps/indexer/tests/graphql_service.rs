...
async fn seed_rows(pool: &PgPool) -> Result<(), sqlx::Error> {
    ...
    sqlx::raw_sql(
        ...
        INSERT INTO contributor (
          ...
          ('0xvoter1', 1135, 'lisk-dao', '0xgovernor', 805, 1700000110, '0xvote1', 805, 1700000110, 100, 10, 1, 1),
          ('0xvoter2', 1135, 'lisk-dao', '0xgovernor', 806, 1700000120, '0xvote2', 806, 1700000120, 25, 5, 0, 0);
