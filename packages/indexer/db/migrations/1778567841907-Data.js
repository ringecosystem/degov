module.exports = class Data1778567841907 {
    name = 'Data1778567841907'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token_balance_checkpoint" ("id" character varying NOT NULL, "chain_id" integer, "dao_code" text, "governor_address" text, "token_address" text, "contract_address" text, "log_index" integer, "transaction_index" integer, "account" text NOT NULL, "previous_balance" numeric NOT NULL, "new_balance" numeric NOT NULL, "delta" numeric NOT NULL, "source" text NOT NULL, "cause" text NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, CONSTRAINT "PK_ab8ad427b7ca90bdbf9704917b6" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_346a8f98fd5c24f8203a446e7a" ON "token_balance_checkpoint" ("chain_id", "governor_address", "token_address", "account", "block_number") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_346a8f98fd5c24f8203a446e7a"`)
