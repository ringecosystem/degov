module.exports = class Data1757675372076 {
    name = 'Data1757675372076'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "potential_power" ("id" character varying NOT NULL, "address" text NOT NULL, "power" numeric NOT NULL, "record" text NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, CONSTRAINT "PK_41e32a90ca99a1731c0d56ea42b" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "potential_power"`)
