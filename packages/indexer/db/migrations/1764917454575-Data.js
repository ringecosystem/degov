module.exports = class Data1764917454575 {
    name = 'Data1764917454575'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "contributor" ("id" character varying NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "last_vote_block_number" numeric, "last_vote_timestamp" numeric, "power" numeric NOT NULL, "delegates_count_all" integer NOT NULL, "delegates_count_effective" integer NOT NULL, CONSTRAINT "PK_816afef005b8100becacdeb6e58" PRIMARY KEY ("id"))`)
