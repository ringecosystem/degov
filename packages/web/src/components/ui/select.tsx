...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full text-foreground cursor-default select-none items-center bg-card rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-background focus:text-foreground/80 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
